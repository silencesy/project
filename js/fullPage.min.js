...
function FullPage(k) {
    ...
    if (e && 1 !== H) {
        ...
        A.prototype = {
            epsilon: 1E-5, sampleCurveX: function (a) {
                return ((this.ax *
        ...
        if ("" !== h) {
            ...
            T = setInterval(function () {
                var a;
                +new Date > s ? (a = r ? "left:" + g + "px;top:" + b + "px;filter:alpha(opacity=" + 100 * r[1] + ");" : "left:" + g + "px;top:" + b + "px;", clearInterval(T)) : (t = s - new Date, m = t / c, m = W.solve(1 - m, A.prototype.epsilon), a = "left:" + (h + q * m) + "px;top:" + (k + l * m) + "px;", r && (a += "filter:alpha(opacity=" + 100 * (r[1] * m - r[0] * (1 - m)) + ");"));
                e.cssText = a
            }, 13)
        };
        X = {
            transform: function (a, g, b) {
                var c = 0, d = "" !== h || "none" !== a.translate && a.translate ? z : -50;
                switch (a.translate) {
                    case "Y":
                        c = b > g ? s : -s;
                        v(e[b], 0, c, 0, a);
            ...
            switch (!0) {
                ...
                case "touch" === a:
                    ...
                    (function () {
                        ...
                        "Y" === w.transform.translate ? (D = function () {
                            ...
                            var e = Math.abs(b.y / s), K = " scale(" + (a + f * e) + ") rotate(" + (c + d * e) + "deg)";
                            ...
                            var e = Math.abs(b.x / m), K = " scale(" + (a + f * e) + ") rotate(" + (c + d * e) + "deg)";
                ...
                case -1 !== a.indexOf("nav:"):
                    (function () {
                        ...
                        c = u[b].className;
                        if (e && u) {
                            for (; f--;)u[f].setAttribute("data-page", f);
                            -1 === c.indexOf("active") && (u[b].className = "" === c ? "active" : c + " active");
                            f = function (a) {
                                var b;
                                a = a || window.event;
                                a = a.target || a.srcElement;
                                for (b = a.tagName.toLowerCase(); "li" !==
                                b;) {
                                    if ("ul" === b)return;
                                    a = a.parentNode;
